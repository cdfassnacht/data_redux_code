...
def read_nirspec_spec(filename, weightfilename=None, weightfiletype='InverseVariance', x1=0, x2=0, y1=0, y2=0, informat='new', verbose=True, trimfile=False):
   """
...
def nir_extract(filename, outname, weightfile=None,trimfile=False,x1=0, x2=0, y1=0, y2=0,
   ...
   print ""
   d,w,v = read_nirspec_spec(filename,weightfilename=weightfile,x1=x1,x2=x2,y1=y1,y2=y2,trimfile=trimfile,informat=informat)
   if informat=='old':
      s = v
   else:
      s = numpy.sqrt(v)
